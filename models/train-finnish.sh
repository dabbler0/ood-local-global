CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/finnish-corpus --vocab /raid/lingo/abau/lm/finnish-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/finnish.lr4-1 --layers 2 --lr 1e-4 --epochs 100 --seed 1 &
CUDA_VISIBLE_DEVICES=7 python train.py --data /raid/lingo/abau/lm/finnish-corpus --vocab /raid/lingo/abau/lm/finnish-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/finnish.lr4-2 --layers 2 --lr 1e-4 --epochs 100 --seed 2 &
