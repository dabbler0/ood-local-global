CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/training-monolingual/news.2007.en.20k.tokenized --vocab /raid/lingo/abau/lm/training-monolingual/20k-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/small-en.lr4-1 --layers 2 --lr 1e-4 --epochs 100 --seed 1 &
CUDA_VISIBLE_DEVICES=7 python train.py --data /raid/lingo/abau/lm/training-monolingual/news.2007.en.20k.tokenized --vocab /raid/lingo/abau/lm/training-monolingual/20k-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/small-en.lr4-2 --layers 2 --lr 1e-4 --epochs 100 --seed 2 &
