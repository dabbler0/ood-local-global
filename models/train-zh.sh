...
CUDA_VISIBLE_DEVICES=12 python train.py --data /raid/lingo/abau/lm/chinese-corpus --vocab /raid/lingo/abau/lm/chinese-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/chinese-1 --layers 2 --lr 3e-4 --epochs 15  --seed 1 &
CUDA_VISIBLE_DEVICES=12 python train.py --data /raid/lingo/abau/lm/chinese-corpus --vocab /raid/lingo/abau/lm/chinese-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/chinese-2 --layers 2 --lr 3e-4 --epochs 15 --seed 2 &
