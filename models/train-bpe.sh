#CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/finnish-bpe --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/finnish-bpe-1 --layers 2 --lr 3e-4 --epochs 20 --seed 1 &
#CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/finnish-bpe --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/finnish-bpe-2 --layers 2 --lr 3e-4 --epochs 20 --seed 2 &
...
for n in 0 0.25 0.5 0.75
do
  CUDA_VISIBLE_DEVICES=7 python train.py --data /raid/lingo/abau/lm/finnish-bpe --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/finnish-bpe-2 --layers 2 --lr 3e-4 --epochs 20 --seed 2 &
done
