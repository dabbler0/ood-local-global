CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/french-corpus --vocab /raid/lingo/abau/lm/french-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/french-1 --layers 2 --lr 3e-4 --epochs 15 --seed 1 &
CUDA_VISIBLE_DEVICES=6 python train.py --data /raid/lingo/abau/lm/french-corpus --vocab /raid/lingo/abau/lm/french-vocab.pt --vocab_size 16384 --output /raid/lingo/abau/lm/monolingual-models/french-2 --layers 2 --lr 3e-4 --epochs 15 --seed 2 &
